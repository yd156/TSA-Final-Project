...
ggplot(dailyprice, aes(x=date, y=daily_mean_price)) +
  geom_line() +
  ggtitle("Average Daily Electricity Price in NYC from 2018 to 2022");
...
dailyload.train.ts_fc <- forecast(dailyload.train.ts,NGprice.fixed.train.ts, h = 365)
...
ARIMA_origin_plot <- autoplot(dailyprice.test.ts, color = "dark grey") +
  autolayer(ARIMA_origin_fc$mean, series="ARIMA_xgre",PI=FALSE,color = "blue") +
